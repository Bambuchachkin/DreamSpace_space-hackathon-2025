...
# plt.imshow(Cloud_Map, cmap='binary', interpolation='nearest')
plt.imshow(Cloud_Map, cmap='gray', vmin=MIN, vmax=MAX)
plt.imsave('Cloud_Map.png', Cloud_Map, cmap='gray', vmin=MIN, vmax=MAX)
np.savetxt('Cloud_Map.txt', Cloud_Map, fmt='%.0f')
plt.show()
